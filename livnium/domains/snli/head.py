...
Takes collapsed state and outputs logits for E/N/C (entailment/neutral/contradiction).
...
class SNLIHead(nn.Module):
    ...
    - alignment between premise (OM) and hypothesis (LO) via kernel.physics
    - opposition between -premise and hypothesis
    - energy feature from alignment
    - distance and norms capturing radial geometry
    - neutral alignment signals
