...
from livnium.classical.livnium_core_system import LivniumCoreSystem, CellClass, RotationAxis, RotationGroup
...
class GeometryQuantumCoupling:
    ...
    def initialize_quantum_state_from_geometry(self, 
        ...
        """
        from livnium.quantum.defaults import MAX_SYMBOLIC_WEIGHT
        ...
        sw_normalized = sw / MAX_SYMBOLIC_WEIGHT
