"""
NLI Dataset Loader (Generic)

Loads NLI data (SNLI/MNLI) from JSONL files.
"""
...
class NLIDataset(LivniumDataset):
    """
    Generic NLI dataset loader.
    
    Works for SNLI and MNLI data formats.
    """
