...
| Model        | Parameters | Size   | Accuracy | Hardware     |
|--------------|------------|--------|----------|-------------|
| BERT-Base    | 110M       | 440MB  | 91.0%    | GPU Cluster |
| RoBERTa-Base | 125M       | 500MB  | 92.5%    | GPU Cluster |
| **Livnium**  | ~13M       | 52.3MB | 96.19%   | MacBook CPU |
