...
from tasks.snli import QuantumSNLIEncoder
...
def main():
    ...
    parser.add_argument("--max-len", type=int, default=128, help="Max token length for quantum encoder")
    ...
    # weights_only must be False so custom objects in checkpoint load correctly
    ...
    dataset = SNLIDataset(samples, vocab=None, max_len=args.max_len, encode_fn=quantum_encode)
